 ...
 * Description: BBS e-Popup support features to produce and manage popups.(English,日本語,中国語,한국어)
 * Version: 2.4.5
 * Author: BBS e-Theme
...
global $wpdb; // [Set] pre action for network site (update 2.4.1)
...
define("BBSE_POPUP_PLUGIN_WEB_URL", plugins_url()."/bbs-e-popup/");
define("BBSE_POPUP_DB_TABLE",$wpdb->prefix."bbse_popup"); // [Set] pre action for network site (update 2.3.7)
define("BBSE_POPUP_AGENT_TABLE",$wpdb->prefix."bbse_popup_agent"); // [Set] pre action for network site (update 2.3.7)
define("BBSE_POPUP_LANGUAGE", get_bloginfo('language'));
define("BBSE_POPUP_AGENT", "bbsetheme");
