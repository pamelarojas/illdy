...
$templateList=Array(
					...
					"ribbon"=>__('Ribbon','BBSe_Popup'), // v2.1.5
					"circle"=>__('Circle','BBSe_Popup'),
					"sound"=>__('Sound','BBSe_Popup'),
					"clock"=>__('Clock','BBSe_Popup'),
					"violet"=>__('Violet','BBSe_Popup'),
					"notice"=>__('Notice','BBSe_Popup'),
					"air"=>__('Air','BBSe_Popup'),
					"triple"=>__('Triple','BBSe_Popup'),
					"leader"=>__('Leader','BBSe_Popup'),
					"photo"=>__('Photo','BBSe_Popup')
					);
?>
			...
			<tr class="userRow hide">
				<td>
					<table class="dataTbls overWhite collapse noTopline" style="width:100%;margin:10px 0;">
						<colgroup><col width="24%"><col width=""></colgroup>
						<tr>
							<td class="noneLine"><span id="sub-title-user-2" class="cursor_default" original-title="<?php echo __('Set popup by user browser.','BBSe_Popup');?>"><?php echo __('Browser','BBSe_Popup');?></span></td>
							<td class="noneLine">
								<select name="bbse_popup_browser" id="bbse_popup_browser" style="width:150px;height:29px;line-height:29px;">
									<option value="All" <?php echo (!$data->popup_browser || $data->popup_browser=='All')?"selected='selected'":"";?>><?php echo __('All','BBSe_Popup');?></option>
									<option value="PC" <?php echo ($data->popup_browser=='PC')?"selected='selected'":"";?>><?php echo __('PC','BBSe_Popup');?></option>
									<option value="Mobile" <?php echo ($data->popup_browser=='Mobile')?"selected='selected'":"";?>><?php echo __('Mobile','BBSe_Popup');?></option>
								</select>
							</td>
						</tr>
					</table>
				...
				<td class="bgB9B9B9">
					<table class="dataTbls overWhite collapse noTopline" style="width:100%;margin:20px 0;">
						...
						for($c=0;$c<sizeof($bbsePopup_closeButton);$c++){
							...
							echo "<td class=\"tbClear btnlist\"><input type=\"radio\" name=\"bbse_popup_close_button\" id=\"bbse_popup_close_button\" ".$btnChecked." value=\"".$bbsePopup_closeButton[$c]."\" /><br>
									<img src=\"".BBSE_POPUP_PLUGIN_WEB_URL."images/btn_close/".$bbsePopup_closeButton[$c]."\" onClick=\"check_button(".$c.");\"></td>";

							if($c%6=='5' && $c<'35') echo "</tr><tr>";
						}
						?>
						</tr>
					</table>
